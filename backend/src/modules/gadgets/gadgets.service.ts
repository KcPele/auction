...
export class GadgetsService {
  ...
  private assertCanView(user: AuthenticatedUser, listing: GadgetListing) {
    assertCanViewListing(user, listing, 'Gadget listing not found');
  }
