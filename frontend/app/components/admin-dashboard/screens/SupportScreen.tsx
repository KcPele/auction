    ...
    <div>
      ...
      <div className="grid h-[calc(100vh-13rem)] grid-cols-1 gap-3 md:grid-cols-[300px_1fr]">
            ...
            {list.map((c) => {
              ...
              return (
                <button
                  ...
                  className={`block w-full border-b border-line/60 px-3 py-2.5 text-left ${isActive ? "bg-bg" : "hover:bg-bg/60"
                    }`}
                >
        ...
        <section className="flex h-full flex-col overflow-hidden rounded-xl border border-line bg-surface">
          {active ? (
            <>
              <header className="flex flex-wrap items-center justify-between border-b border-line px-3.5 py-2.5">
                ...
                <div className="flex gap-1.5">
                  ...
                  <button
                    ...
                    className="rounded-md whitespace-nowrap border border-accent/40 bg-accent/[0.08] px-2.5 py-1.5 text-xs font-semibold text-accent disabled:opacity-40"
                  >
                    Hand back to AI
                  </button>
                  <button
                    ...
                    className="rounded-md whitespace-nowrap border border-green/40 bg-green/[0.08] px-2.5 py-1.5 text-xs font-semibold text-green disabled:opacity-40"
                  >
                    Resolve
                  </button>
                </div>
