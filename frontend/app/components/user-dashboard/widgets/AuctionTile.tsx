  ...
  return (
    ...
    >
      <div className="relative flex aspect-[4/3] items-center justify-center bg-media-background text-media-foreground">
        ...
        <span className="absolute bottom-2.5 right-2.5 rounded-[5px] border border-line bg-overlay px-2 py-1 font-mono text-[11px] text-status-foreground tabular-nums backdrop-blur">
