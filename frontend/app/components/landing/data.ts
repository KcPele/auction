import type { Auction, Step } from "./types";
...
export const FAQS: { q: string; a: string }[] = [
  ...
  { q: "How do I fund my wallet?", a: "Top up via Strowallet directly from your dashboard. Once the Strowallet webhook confirms settlement, your available balance updates. Top-ups are near-instant." },
